 ...
 */
void ingresar_edad_usuarios(int *edad_usuario) {
 ...
 */
bool es_campeon(int *inte_campeon, int *fuer_campeon,
...
int main() {
  ...
  do {
    ...
    if (continuar != DETENER_PROGRAMA) {
      ingresar_edad_usuarios(&edad_usuario);
      if (edad_usuario >= EDAD_USUARIO_MINIMA) {
        ...
        es_mejor_que_campeon(inte_campeon, fuer_campeon, capacidad_mag_campeon,
                             inte_usuario, fuer_usuario, capacidad_mag_usuario);
        if (!es_campeon(&inte_campeon, &fuer_campeon, &capacidad_mag_campeon,
                        inte_usuario, fuer_usuario, capacidad_mag_usuario,
                        &cambio_campeon)) {
          cambiar_el_campeon(&inte_campeon, &fuer_campeon,
                             &capacidad_mag_campeon, inte_usuario, fuer_usuario,
                             capacidad_mag_usuario, &cambio_campeon);
        }
        posicion_actual++;
        if (cambio_campeon) {
